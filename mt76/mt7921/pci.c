...
static const struct pci_device_id mt7921_pci_device_table[] = {
	...
	{ PCI_DEVICE_SUB(PCI_VENDOR_ID_MEDIATEK, 0x7902, 0x14C3, 0x7902),
		.driver_data = (kernel_ulong_t)MT7902_FIRMWARE_WM },
	{ PCI_DEVICE_SUB(PCI_VENDOR_ID_MEDIATEK, 0x7902, 0x14C3, 0x1EDE),
		.driver_data = (kernel_ulong_t)MT7902_FIRMWARE_WM },
	{ PCI_DEVICE_SUB(PCI_VENDOR_ID_MEDIATEK, 0x7902, 0x1A3B, 0x5520),
		.driver_data = (kernel_ulong_t)MT7902_FIRMWARE_WM },
	{ PCI_DEVICE_SUB(PCI_VENDOR_ID_MEDIATEK, 0x7902, 0x1A3B, 0x5521),
		.driver_data = (kernel_ulong_t)MT7902_FIRMWARE_WM },
	{ },
};
...
static int mt7921_dma_init(struct mt792x_dev *dev)
{
	...
	is_7902 = mt7921_l1_rr(dev, MT_HW_CHIPID) == 0x7902;
...
MODULE_DESCRIPTION("MediaTek MT7921E/MT7902E (PCIe) wireless driver");
